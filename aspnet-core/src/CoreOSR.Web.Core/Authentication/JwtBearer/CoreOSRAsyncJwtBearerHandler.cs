...
{
    public class CoreOSRAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public CoreOSRAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
