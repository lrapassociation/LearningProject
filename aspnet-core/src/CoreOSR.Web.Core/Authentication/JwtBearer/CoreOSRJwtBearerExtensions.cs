...
/// </summary>
public static class CoreOSRJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, CoreOSRAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
