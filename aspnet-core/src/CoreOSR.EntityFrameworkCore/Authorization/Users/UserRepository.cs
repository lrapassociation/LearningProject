...
{
    public class UserRepository : CoreOSRRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<CoreOSRDbContext> dbContextProvider)
