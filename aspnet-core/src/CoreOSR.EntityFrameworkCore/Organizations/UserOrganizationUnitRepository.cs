...
namespace CoreOSR.Organizations
{
    public class UserOrganizationUnitRepository : CoreOSRRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<CoreOSRDbContext> dbContextProvider)
