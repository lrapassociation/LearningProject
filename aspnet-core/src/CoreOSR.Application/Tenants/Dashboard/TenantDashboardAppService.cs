...
using CoreOSR.Tenants.Dashboard.Dto;

namespace CoreOSR.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : CoreOSRAppServiceBase, ITenantDashboardAppService
    {
