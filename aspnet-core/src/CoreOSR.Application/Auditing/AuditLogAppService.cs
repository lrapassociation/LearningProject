...
using CoreOSR.Auditing.Exporting;
using CoreOSR.Authorization;
using CoreOSR.Authorization.Users;
using CoreOSR.Dto;
using CoreOSR.EntityHistory;
using EntityHistoryHelper = CoreOSR.EntityHistory.EntityHistoryHelper;

namespace CoreOSR.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CoreOSRAppServiceBase, IAuditLogAppService
    {
