...
using CoreOSR.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace CoreOSR.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : CoreOSRAppServiceBase, IDashboardCustomizationAppService
    {
