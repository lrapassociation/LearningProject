...
using CoreOSR.DynamicEntityPropertyValues.Dto;

namespace CoreOSR.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : CoreOSRAppServiceBase, IDynamicEntityPropertyValueAppService
    {
