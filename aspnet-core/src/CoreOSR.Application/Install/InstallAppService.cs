...
using CoreOSR.Migrations.Seed.Host;
...
namespace CoreOSR.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CoreOSRAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CoreOSRDbContext> _migrator;
