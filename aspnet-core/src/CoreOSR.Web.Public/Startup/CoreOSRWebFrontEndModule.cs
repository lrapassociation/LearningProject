...
{
    [DependsOn(
        typeof(CoreOSRWebCoreModule)
    )]
    public class CoreOSRWebFrontEndModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CoreOSRWebFrontEndModule).GetAssembly());
        }
    }
}
