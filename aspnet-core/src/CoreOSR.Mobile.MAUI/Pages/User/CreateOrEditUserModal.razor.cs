...
using CoreOSR.Mobile.MAUI.Models.User;
using CoreOSR.Mobile.MAUI.Services.User;
using CoreOSR.Mobile.MAUI.Shared;
using CoreOSR.Services.Permission;
using CoreOSR.Validations;

namespace CoreOSR.Mobile.MAUI.Pages.User
{
    public partial class CreateOrEditUserModal : ModalBase
    {
        ...
        public bool IsNewUser
        {
            ...
            {
                _isNewUser = value;
                _isDeleteButtonVisible = !_isNewUser && PermissionService.HasPermission(PermissionKey.UserDelete);
                _isUnlockButtonVisible = !_isNewUser && PermissionService.HasPermission(PermissionKey.UserEdit);
