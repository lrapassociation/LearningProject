...
using CoreOSR.Services.Navigation;
using Microsoft.AspNetCore.Components;
using CoreOSR.Mobile.MAUI.Services.Account;
using CoreOSR.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using CoreOSR.Mobile.MAUI.Services.Tenants;

#if ANDROID
using CoreOSR.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace CoreOSR.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new CoreOSR.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
