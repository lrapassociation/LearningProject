...
namespace CoreOSR
{
    ...
    public class CoreOSRCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            CoreOSRLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, CoreOSRMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CoreOSRSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CoreOSRCoreModule).GetAssembly());
        }
