...
using CoreOSR.Controls;
using CoreOSR.Dto;
using CoreOSR.Extensions;
using CoreOSR.Localization;
using CoreOSR.UI;
using CoreOSR.UI.Assets;
using CoreOSR.Views;
using DependencyResolver = CoreOSR.Core.Dependency.DependencyResolver;
...
namespace CoreOSR.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CoreOSR";
